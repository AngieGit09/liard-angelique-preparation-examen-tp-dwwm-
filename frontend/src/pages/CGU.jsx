  ...
  return (
    ...
    <section className="container py-5" style={{ maxWidth: "900px" }}>
      ...
      <p className="mb-4">
        ...
        définir les modalités et conditions d’accès et d’utilisation du site
        RénoMeuble. Toute navigation sur le site implique l’acceptation pleine
      ...
      <p className="mb-4">
        ...
        accès internet. Tous les frais nécessaires à l’accès au site (matériel
      ...
      <p className="mb-4">
        Le site RénoMeuble propose la présentation et la mise en vente de
        meubles rénovés. Les informations fournies sur le site sont données à
      ...
      <p className="mb-4">
        Les contenus présents sur le site (textes, images, logos, graphismes)
      ...
      <p className="mb-4">
        ...
        uniquement dans le cadre des services proposés et ne sont pas transmises
      ...
      <p className="mb-4">
        ...
        utilisateur et d’analyser la fréquentation. L’utilisateur peut
      ...
      <p className="mb-4">
        ...
        d’utilisation à tout moment. Les utilisateurs sont invités à les
      ...
      <p>
        ...
        litige, les tribunaux compétents seront ceux du ressort du siège social
        de l’entreprise.
      </p>
    </section>
  );
